const villes = [
  ...
  const nomsDesVilles = villes.map(ville => ville.nom); // <- utilisez une la méthode adaptée sur "villes"
  ...
  */
  ...
  // 30143
  const sommeHabitants = villes.reduce((resultat, ville) => resultat + ville.population, 0)
